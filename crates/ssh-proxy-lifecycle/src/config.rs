...
#[derive(Debug, Clone)]
pub struct PeerConfigFiles {
    pub config_toml: String,
    pub peer_state_json: String,
    pub install_report_json: String,
...
pub fn materialize_peer_config(input: &PeerConfigInput) -> PeerConfigFiles {
...
pub fn service_install_report_json(
    state: &str,
